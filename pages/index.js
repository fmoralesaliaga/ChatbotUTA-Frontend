        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-7xl">
              Bienvenidos a ChatBox UTA!
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Accede a las preguntas más frecuentes acerca de la Universidad de Tarapacá, o también consulta por tu información persona referente a la Universidad!
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a href="/chat" className="text-sm font-semibold leading-6 text-gray-900">
                Acceder al chat sin identificarse <span aria-hidden="true">→</span>
              </a>
            </div>
          </div>
        </div>
