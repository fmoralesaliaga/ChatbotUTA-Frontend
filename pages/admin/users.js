...
import EditUserModal from '../../components/Modals/EditUserModal'; // Importa el componente de modal de edición
  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
                      ...
                      <li key={user.id} className="flex justify-between gap-x-6 py-5">
                          ...
                          <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                              <div className="flex gap-x-6"> 
                                  <button className="-mx-1 block rounded-lg bg-emerald-600 px-5 py-2.5 text-base font-semibold text-white leading-7 text-gray-900 hover:bg-emerald-700" onClick={() => openEditModal(user)}>
                                      Editar
                                  </button>
                                  {editModalOpen === user.id && <EditUserModal user={user} isOpen={true} onClose={closeEditModal} fetchUsers={fetchUsers}/>}
                                  <button className="-mx-1 block rounded-lg bg-red-500 px-5 py-2.5 text-base font-semibold text-white leading-7 text-gray-900 hover:bg-red-600" onClick={() => deleteUser(user.id)}>
                                      Eliminar
                                  </button>
                              </div>
                          </div>
          ...
          {isCreateModalOpen && (<CreateUserModal isOpen={isCreateModalOpen} onClose={closeCreateModal} onCreate={handleCreateUser}/>
        )}
          <div
