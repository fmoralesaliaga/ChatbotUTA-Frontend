...
function EditAnswerModal({ answer, isOpen, onClose, fetchAnswers}) {
    ...
    const handleInputChange = (e) => {
      ...
      setEditedAnswer({ ...editedAnswer, [name]: value });
    };
    ...
    const handleUpdateAnswer = async () => {
      try {
        ...
        await axios.put(`http://localhost:3000/api/answers/${answer.id}`, editedAnswer);
        fetchAnswers();
